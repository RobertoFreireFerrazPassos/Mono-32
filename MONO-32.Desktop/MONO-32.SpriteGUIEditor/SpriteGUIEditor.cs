...
public class SpriteGUIEditor : Game
{
    ...
    protected override void Initialize()
    {
        ...
        palette = new Palette(new Color[]
        {
            ...
            new Color(0xC7, 0x15, 0x85), // Medium Violet Red
            new Color(0xE6, 0x6F, 0x61), // Salmon Pink
            new Color(0xFF, 0xA0, 0x7A), // Peach
            ...
            new Color(0xDA, 0x70, 0xD6), // Orchid
            new Color(0xD8, 0xBF, 0xD8), // Thistle
            new Color(0x8A, 0x2B, 0xE2), // Blue Violet
            new Color(0xC7, 0x15, 0x85),  // Medium Violet Red
            ...
            new Color(0x9A, 0xCD, 0x32), // Yellow Green
            new Color(0x2E, 0x8B, 0x57), // Sea Green
            new Color(0x3C, 0xB3, 0x71), // Medium Sea Green
            new Color(0x9C, 0xFF, 0x9C), // Honeydew
            ...
            new Color(0xFF, 0xB6, 0xC1), // Light Pink
            ...
            new Color(0x87, 0xCE, 0xEB), // Sky Blue
            new Color(0x46, 0x82, 0xB4), // Steel Blue
            new Color(0x00, 0xBF, 0xFF), // Deep Sky Blue
            new Color(0xAD, 0xD8, 0xE6), // Light Blue 2
